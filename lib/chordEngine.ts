...
const CHORD_TYPES: ChordType[] = [
  ...
  { suffix: "m",      roles: ["c","o","i","c","o","i","k","c","k","i","i","i"] },
  { suffix: "mM7",    roles: ["c","o","i","c","o","i","k","c","o","i","o","c"] },
  { suffix: "m7",     roles: ["c","o","i","c","o","i","k","c","k","i","c","o"] },
  { suffix: "m6",     roles: ["c","o","i","c","o","i","k","c","o","c","o","i"] },
